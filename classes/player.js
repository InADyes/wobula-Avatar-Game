class player {
	...
	addBodyParts() {
		...
		this.characterChest = game.add.sprite(0, -110, 'char1Chest');
		this.characterChest.anchor.setTo(.5, .5);
		this.characterArm2 = game.add.sprite(35, -145, 'char1ArmL');
		this.characterArm2.anchor.setTo(0, 0);
		this.characterArm1 = game.add.sprite(-20, -145, 'char1ArmR');
		...
		this.characterPelvis = game.add.sprite(0, -10, 'char1Pelvis');
